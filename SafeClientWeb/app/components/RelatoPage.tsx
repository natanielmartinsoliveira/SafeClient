    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4"
        ...
        <div className="w-full max-w-sm mx-auto rounded-2xl shadow-xl p-10 flex flex-col items-center gap-5 text-center"
          ...
          <p className="text-xl font-bold" style={{ color: '#2E1B6E' }}>Relato enviado!</p>
          <p className="text-sm" style={{ color: '#9887B8' }}>
            Agradecemos a sua contribuição.<br />Unidas vamos proteger todas nós. ♥
          </p>
    ...
    <div className="flex flex-col items-center px-4 py-8"
      ...
      <div className="w-full max-w-lg">
        <p className="text-xs mb-6" style={{ color: '#9887B8' }}>
          Postando como <span className="font-semibold" style={{ color: '#7B52B8' }}>{userEmail}</span>
        </p>
      </div>
      <main className="w-full max-w-lg flex flex-col gap-6">
        <div className="w-full max-w-lg flex flex-col gap-6">
          ...
          <div>
            <h1 className="text-2xl font-black" style={{ color: '#2E1B6E' }}>Novo Relato</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold" style={{ color: '#6B5B9E' }}>Tipo de contato</label>
            ...
            {/* Contato */}
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold" style={{ color: '#6B5B9E' }}>Contato</label>
              <div className="flex items-center rounded-xl px-4 gap-2"
            ...
            <div className="rounded-xl px-4 py-3 flex gap-3"
              ...
              <p className="text-xs leading-relaxed" style={{ color: '#92400E' }}>
                Este relato ficará vinculado à sua conta. Relatos falsos ou caluniosos podem resultar em responsabilização civil.
              </p>
            </div>

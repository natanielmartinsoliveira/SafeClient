...
export default async function AdminDashboard() {
  ...
  const cards = [
    ...
    {
      label: 'Relatos Ativos',
      value: stats?.activeReports ?? '—',
      color: '#059669',
      bg: '#D1FAE5',
    },
    {
      label: 'Relatos Inativos',
      value: stats?.inactiveReports ?? '—',
      color: '#D97706',
      bg: '#FEF3C7',
    },
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {cards.map((c) => (
          ...
          >
            <p className="text-xs font-semibold" style={{ color: '#9887B8' }}>
              {c.label}
            </p>
      ...
      >
        <p className="text-sm" style={{ color: '#9887B8' }}>
          Bem-vindo ao painel de administração SafeClient. Use o menu lateral para gerenciar relatos
          e usuários.
        </p>
      </div>
    </div>
